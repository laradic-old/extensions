 ...
 */
class Extension5 implements ArrayAccess
{
    use EventDispatcher;
    ...
    public function install()
    {
        ...
        $this->extensions->recordInstall($this->slug);
        $this->extensions->updateRecords();
    ...
    public function uninstall()
    {
        ...
        $this->extensions->recordUninstall($this->slug);
        $this->getExtensions()->updateRecords();
    ...
    public function ensureRecord()
    {
        ...
        if ( ! $this->record = $this->extensions->getRecord($this->slug) )
        {
            if ( ! $this->extensions->recordCreate($this->slug) )
            {
    ...
    {
        $this->record = $this->extensions->getRecord($this->slug);
        return $this;
    }
